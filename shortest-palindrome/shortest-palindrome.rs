...
//
// https://github.com/z-Wind/LeetCode/blob/main/longest-palindromic-substring/longest-palindromic-substring.rs
//
...
impl Solution {
    pub fn shortest_palindrome(s: String) -> String {
        ...
        //println!("{}\n{}\n{:?}\n{}\n", s, si, v, max_index);
        let r = v[max_index];
        let right = (max_index-r)/2+r;
        format!("{}{}", s[right..].chars().rev().collect::<String>(), s)
    }
}